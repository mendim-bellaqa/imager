...
<html lang="en">
    <head>
      ...
      <title>NGARKO FOTO- FOTOPRINTERI</title>
...
<body style="background-image: url('images/background-01.jpg');">
    <main class="justify-center text-center align-center container mx-auto max-w-screen-lg h-full">

                    <a  href="/" class="justify-center text-center align-center flex items-center top-5">
                        <img style="width:200px; margin-top:50px; margin-bottom:25px; " href="/" src="images/fotoprinteri_logo.png">
                    </a>
        ...
        <article aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white shadow-xl rounded-md" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);" ondragleave="dragLeaveHandler(event);" ondragenter="dragEnterHandler(event);">
                <div id="overlay" class="w-full h-full absolute top-0 left-0 pointer-events-none z-50 flex flex-col items-center justify-center rounded-md">
                    ...
                    <p class="text-lg text-blue-700">Ngarko fotot</p>
                </div>

            <form action="{{ route('ngarko-foto/save') }}" method="post" enctype="multipart/form-data">
                    @csrf

...
<head>
  ...
  <title>FOTOPRINTERI - DASHBOARD</title>
  <!-- plugins:css -->
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Mirësevini Administrator</h3>
                  {{-- <h6 class="font-weight-normal mb-0">Të gjitha sistemet funksionojnë pa probleme! Ju keni <span class="text-primary">3 sinjalizime të palexuara!</span></h6> --}}
                </div>

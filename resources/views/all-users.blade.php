            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Të gjith përdoruesit</h3><br>
                  <h6 class="font-weight-normal mb-0">Lista e të gjith përdoruesve</h6><br>
                </div>
          ...
          <table class="min-w-full">
            <thead class="bg-gray-50 dark:bg-gray-700">
              <tr>
                ...
                {{-- <th scope="col" class="relative py-3 px-6"><span class="sr-only">Edit</span></th> --}}
                </tr>
                </thead>
            <tbody>
